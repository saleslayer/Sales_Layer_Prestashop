...
class saleslayerimportdiagtoolsModuleFrontController extends ModuleFrontController
{
    ...
    public function displayAjax()
    {
       ...
       // $this->SLimport->debbug('Stat of memory before prepare send->'.(microtime( 1) - $microtime_load_process),'syncdata');
      ...
      //  $microtime_load_process = microtime(1);
       ...
       // $this->SLimport->debbug('Stat of memory after JSON_HEX_QUOT ->'.(microtime( 1) - $microtime_load_process),'syncdata');
     ...
     * @return array
     */
    public function showContentFile($logfile,$lineNumber){
