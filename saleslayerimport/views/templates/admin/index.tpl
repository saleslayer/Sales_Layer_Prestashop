...
<div class="container mar-top-btt-40">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-4 col-sm-12 pad-10">
            <a href="{$link_all_conectors}" class="btn btn-success width-150 mar-10" ><i class="fa fa-eye" aria-hidden="true"></i> View connectors</a>
        </div>
        <div class="row">
...
<div class="row mar-top-btt-40" id="slyr-import-module-block">
    ...
    <form action="" method="post" autocomplete="off" role="form" class="col-md-6 mar-top-btt-40 slyr-import-form-login form-group" >
        ...
        <div class="slyr-form-field-block form-group">
            ...
            <input type="text" id="saleslayerimport_api_client" name="api_client" value="{$api_client}" />
        </div>
        <div class="slyr-form-field-block form-group">
            <label for="saleslayerimport_api_key">Private Key:</label>
            <input type="text" id="saleslayerimport_api_key" name="api_key" value="{$api_key}" />
        </div>
        <div class="slyr-form-field-block mar-top-btt-40 form-group">
            <button type="submit" class="btn btn-info width-150" name="addnewconector"><i class="fa fa-refresh text-left" aria-hidden="true"></i> Save Connector</button>
        </div>
    </form>
</div>
</div>
